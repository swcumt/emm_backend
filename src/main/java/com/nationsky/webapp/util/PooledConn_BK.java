...
public class PooledConn_BK {
	...
	private static PooledConn_BK instance = null;
	...
	public static PooledConn_BK getInstance()
	{
		if(instance == null)
		{
			instance = new PooledConn_BK();
		}
		return instance;
	}
