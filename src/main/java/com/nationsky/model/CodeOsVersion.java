...
@Entity
@Table(name = "code_os_version", catalog = "emm_backend")
@Indexed
@XmlRootElement
public class CodeOsVersion extends BaseEntity implements Serializable {
	private Long id;
	private String text;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CodeOsVersion other = (CodeOsVersion) obj;
		if (id == null) {
			if (other.id != null)
				return false;
